...
<body>
    ...
    <div class="card">
        ...
        <div class="card-header"><a href="adminNoticeList"><h1>스타벅스 공지사항 어드민</h1></a></div>
        ...
        <div class="card-body">
            ...
            <c:forEach items="${freeBoardVOList}" var="freeBoard">
                <div class="content-box">
                    ...
                    <div class="title"><a href='./adminNoticeUpdateForm?num=<c:out value="${freeBoard.num}" />'><c:out value="${freeBoard.subject}" /></a></div>
                    <div><c:out value="${freeBoard.hit}" /></div>
                    <div class="delete"><button style="cursor: pointer;" onClick='javascript: noticeDelete(<c:out value="${freeBoard.num}" />);'>X</button></div>
                </div>
            </c:forEach>
        </div>
